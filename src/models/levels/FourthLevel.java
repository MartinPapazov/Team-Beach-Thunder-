...
public class FourthLevel extends Level {
    ...
    protected void spaceShipRotation(Spaceship spaceship) {
        ...
        boolean isEnemyShipAtTopLine = spaceship.getY() <= 20 + Constants.GameStatusBar;
        boolean isEnemyShipAtBottomLine = spaceship.getY() >= Constants.WindowHeight - spaceship.getHeight() - 50;
